...
const std::vector<Recipe>& GetRecipes() {
  static const std::vector<Recipe> recipes = {
      ...
      {"Powered Drill", {{ItemId::IronPlate, 5}, {ItemId::IronGear, 2}}, {ItemId::PoweredDrill, 1}, 1.6f, true,
       false},
      {"Wall", {{ItemId::Stone, 2}}, {ItemId::Wall, 1}, 0.4f, true, false},
      {"Turret", {{ItemId::IronPlate, 5}, {ItemId::IronGear, 2}}, {ItemId::Turret, 1}, 1.5f, true, false},
      {"Ammo", {{ItemId::IronPlate, 1}}, {ItemId::Ammo, 4}, 0.6f, true, false},
